#
#  Be sure to run `pod spec lint DDKeyPathChannel.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/djs66256/DDKeyPathChannel"
  ...
  s.source       = { :git => "https://github.com/djs66256/DDKeyPathChannel.git", :tag => "#{s.version}" }
